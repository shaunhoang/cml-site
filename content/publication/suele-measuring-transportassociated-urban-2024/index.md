...
# Associated Projects
# Add Project's folder or file name without extension.
projects: []

# Slides
# Associate this publication with Markdown slides. E.g. `slides: "example"` references `content/slides/example/index.md`.
slides: ""
---
